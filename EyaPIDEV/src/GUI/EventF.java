 ...
 * @author user
 */
public class EventF extends Form{
    // static  Form f;
   // SpanLabel lb;
     Label titre ; 
    Label date ;
    ...
    {  
        ...
        //  this.header("Nos évènements");
         ...
         Container events = new Container(new FlowLayout(CENTER));
       // lb = new SpanLabel("");
       // f.add(lb);
     ...
     ArrayList<Event> a = service.getList() ;
        ...
        for (Event ev : a) 
       {
            ...
            URLImage urlImage = URLImage.createToStorage(placeholder, ev.getImage(), "http://localhost/sprint_web-eyaaa/tunfugees/web/uploads/image/"+ev.getImage());
