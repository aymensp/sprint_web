...
public class RefugiesService {
    ...
    public ArrayList<Refugies> getList2() {
        ...
        con.setUrl("http://localhost/tunfugees/web/app_dev.php/front/");
    ...
    {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/tunfugees/web/app_dev.php/front/back/delete/"+gm.getIdref());
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
     ...
     public boolean ajouter(Refugies g) {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/tunfugees/web/app_dev.php/front/new/"+ g.getNom()+"/"+ g.getPrenomn()+"/"+ g.getAge()+"/"+ g.getPays()+"/"+ g.getImage());
    ...
    {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/tunfugees/web/app_dev.php/front/viwes/"+ g.getIdref()+"/"+ g.getNom()+"/"+g.getPrenomn()+"/"
             +g.getPays()+"/"+g.getImage());
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                responseResult = con.getResponseCode() == 200; //Code HTTP 200 OK
