...
//                a.setCin(Integer.parseInt(obj.get("cin").toString()));
    ...
    public ArrayList<Volontaire> getList(Event v) {//LISTE DES VOLONTAIRES FIL EVENT
        ...
        con.setUrl("http://127.0.0.1:8000/events/jsonlist/"+v.getId_event());
    ...
    public ArrayList<Volontaire> getList2() {//VolontaireeeeeeeSSSS
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://127.0.0.1:8000/events/jsonlist2");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                try {
    ...
    {  ConnectionRequest con = new ConnectionRequest();
        String url = "http://127.0.0.1:8000/volontaire/jsonedit2/"+g.getId_vol()+"/" + g.getPresence();
       ...
       public boolean ajouter(Volontaire g, Event e) {
        ConnectionRequest con = new ConnectionRequest();
        String url = "http://127.0.0.1:8000/volontaire/jsonadd2/" 
    ...
    return s;
        ...
        public boolean noparticiper(int id, String mail){
            ConnectionRequest con = new ConnectionRequest();
        String url = "http://127.0.0.1:8000/volontaire/jmscancel/"+id+"/"+mail; //création de l'URL                                                       
        con.setUrl(url);// Insertion de l'URL de notre demande de connexion
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
