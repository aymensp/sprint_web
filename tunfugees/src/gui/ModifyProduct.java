 ...
 * @author anasc
 */
public class ModifyProduct extends BaseForm {
   ...
   // File file;
    ...
    public ModifyProduct(Produit p,Resources res) {
       ...
       // Region = annonceS.getRegion();
        ...
        tnom = new TextField(p.getNomProd(), p.getNomProd());
        nomr= new TextField(p.getNomRef(),p.getNomRef());
        tdesc = new TextField(p.getDescription(), p.getDescription(), 500, TextArea.ANY);
        tprix = new TextField(p.getPrix().toString(), p.getPrix().toString());
        btnajout = new Button("ajouter");
        btncapture = new Button("Select Image");
        fileNameInServer=p.getPhoto();
        ...
        try {
            ...
            img1 = Image.createImage("file:/C:/wamp64/www/final/tunfugees/web/uploads/Produit/photo/"+p.getPhoto()).fill(500, 700);
        ...
        btnajout.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if (tnom.getText().equals("") || tdesc.getText().equals("") || tprix.getText().equals("")) {
                    ...
                    Produit a = new Produit(p.getId(),tnom.getText(),nomr.getText(), tdesc.getText(), Double.parseDouble(tprix.getText()), reg, fileNameInServer, idc);
                    annonceS.modifierAnnonce(a);
                    new GestionProduit(res).show();
                }
